    ...
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          ...
          <router-link :to="{name: 'home'}" class="text-sm font-semibold leading-6 text-gray-900" :class="{'text-indigo-600': $route.name === 'home'}">Home</router-link>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Features</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Marketplace</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Company</a>
        </PopoverGroup>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <router-link :to="{name: 'login'}" class="text-sm font-semibold leading-6 text-gray-900" :class="{'text-indigo-600': $route.name === 'login'}">Log in</router-link>
        </div>
      </nav>
